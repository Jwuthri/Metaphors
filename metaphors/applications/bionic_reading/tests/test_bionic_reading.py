...
class TestBionicReading(unittest.TestCase):
    def test_html_correct(self):
        ...
        expected_output = "<!DOCTYPE html><html><head><style>b {font-weight: 700}</style></head><body><p><b>W</b>e <b>ar</b>e <b>hap</b>py <b>i</b>f <b>a</b>s <b>ma</b>ny <b>peop</b>le <b>a</b>s <b>possi</b>ble <b>ca</b>n <b>us</b>e <s>the</s> <b>advan</b>tage <s>of</s> <b>Bion</b>ic <b>Read</b>ing.</p></body></html>"
        self.assertTrue(
